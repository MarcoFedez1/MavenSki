...
public class ikonEpicTest {
    ...
    @Test (priority = 0, description = "Verify that clicking epic image on PopUp from main page it goes to Ikon page")
    ...
    @Test (priority = 6, description = "Verify that clicking on 'Lets Book It' travelers information page should be displayed")
	...
	public void setTravelers() throws InterruptedException   {
    	...
    	String [] bdays = {"06/25/1985", "02/14/2009", "08/07/1990", "10/14/2012" };
